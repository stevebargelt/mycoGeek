import StrainListings from "@/app/components/StrainListings.jsx";
import { getStrains } from "@/app/firebase/firestore.js";
...
export default async function Home({ searchParams }) {
  ...
  const restaurants = await getStrains(searchParams);
  return (
